...
const entries = defineCollection({
  ...
  schema: z.object({
    ...
    embodied_patterns: z.array(z.string()).optional(),
    relation_types: z.array(z.string()).optional(),
    structure: z.union([z.string(), z.array(z.string())]).optional(),
    abstraction_level: z.enum(["primitive", "generic", "specific"]).optional(),
